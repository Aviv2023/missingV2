...
jqueryWidget: {
    _init: function() {
        ...
        this.mode = dget(this.options, "mode", "speeded acceptability");
        ...
        this.wordTime = dget(this.options, "wordTime", this.display == "in place" ? 420 : 480); // Only for speeded accpetability.
        this.wordPauseTime = dget(this.options, "wordPauseTime", this.display == "in place" ? 1 : 150); // Ditto.
